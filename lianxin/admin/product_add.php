...
if($_REQUEST["action"]=="add")
{
    ...
    $dataArray = array("parent_id"=>$parent_id,"cat_id"=>$cat_id,"is_show"=>$is_show,"title"=>$title,"cat_id"=>$cat_id,"picture"=>$picture,"file_url"=>$file_url,"laiyuan"=>$laiyuan,"tags"=>$tags,"sort_order"=>$sort_order,"note"=>$note,"content"=>$content,"add_time"=>$add_time);
	$mysql->insert("news",$dataArray);
	echo '<script>alert("操作成功");location.href="product_add.php?parent_id='.$parent_id.'";</script>';
	exit;
}
...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
      <form action="product_add.php?action=add&parent_id=<?php echo $parent_id; ?>" method="post" name="theForm" onsubmit="return check_submit();">
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            ...
            <tr>
                ...
                <td width="83%">
                    <input type="radio" id="yes" name="is_show"  value="1" />
                    <label for="yes">是</label>
                    <input type="radio" id="no" name="is_show"  value="0" />

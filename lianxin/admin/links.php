...
if($_REQUEST["action"]=="add")
{
	...
	echo '<script>alert("操作成功");location.href="links.php?cat_id='.$cat_id.'";</script>';
	exit;
}
...
{
?>
  <form method="post" action="links.php?action=edit&id=<?php echo $result['id']; ?>&cat_id=<?php echo $result['cat_id']; ?>" name="listForm_<?php echo $result['id']; ?>">
  <tr>
    ...
    <td align="center">
      ...
      <a href="links.php?action=delete&id=<?php echo $result['id']; ?>&cat_id=<?php echo $result['cat_id']; ?>" title="删除" onClick="return confirm('您确定进行删除操作吗？')"><img src="images/icon_trash.gif" width="16" height="16" border="0" /></a>
    </td>
  </tr>
  </form>
<?php 
...
<table width="1103" cellpadding="3" cellspacing="1" style="margin-top:20px;">
  <tr>
    ...
    <th width="141">操作</th>
  <tr>
  <form method="post" action="links.php?action=add&cat_id=<?php echo $cat_id; ?>" name="listForm" onsubmit="return confirmSubmit(this)">
  <tr>

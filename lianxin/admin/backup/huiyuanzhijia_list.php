...
if ($_REQUEST['action'] == 'delete')
{
	...
	echo '<script>alert("操作成功");location.href="huiyuanzhijia_list.php?cat_id='.$L_cat_id.'&keywords='.$L_keywords.'&page='.$L_page.'";</script>';
	exit;
}
...
<!-- 文章列表 -->
<form method="post" action="huiyuanzhijia_list.php?L_cat_id=<?php echo $cat_id; ?>&L_keywords=<?php echo $keywords; ?>&L_page=<?php echo $page; ?>" name="listForm" onsubmit="return confirmSubmit(this)">
  <!-- start goods list -->
  <div class="list-div" id="listDiv">
<table width="1103" cellpadding="3" cellspacing="1">
  <tr>
    <th width="51"><input name="checkall" id="checkall" type="checkbox" /></th>
    <th width="78">ID</th>
    <th width="543">标题</th>
    <th width="81">排序</th>
...
?>
  <tr>
    ...
    <td class="first-cell" style=""><a href="huiyuanzhijia_edit.php?id=<?php echo $result['id']; ?>&L_cat_id=<?php echo $cat_id; ?>&L_keywords=<?php echo $keywords; ?>&L_page=<?php echo $page; ?>"><?php echo $result['title']; ?></a></td>
    <td align="center"><?php echo $result['sort_order']; ?></td>
    <td align="center"><?php echo $result['add_time']; ?></td>
    <td align="center">
      <a href="huiyuanzhijia_edit.php?id=<?php echo $result['id']; ?>&L_cat_id=<?php echo $cat_id; ?>&L_keywords=<?php echo $keywords; ?>&L_page=<?php echo $page; ?>" title=""><img src="images/icon_edit.gif" width="16" height="16" border="0" /></a>
      <a href="huiyuanzhijia_list.php?action=delete&id=<?php echo $result['id']; ?>&L_cat_id=<?php echo $cat_id; ?>&L_keywords=<?php echo $keywords; ?>&L_page=<?php echo $page; ?>" title="" onClick="return confirm('您确定进行删除操作吗？')"><img src="images/icon_trash.gif" width="16" height="16" border="0" /></a>
    </td>
  </tr>
<?php
}
$gotoPageFirst = "huiyuanzhijia_list.php?cat_id=".$cat_id."&keywords=".$keywords."&page=1";
$gotoPagePrev = "huiyuanzhijia_list.php?cat_id=".$cat_id."&keywords=".$keywords."&page=".($page-1);
$gotoPageNext = "huiyuanzhijia_list.php?cat_id=".$cat_id."&keywords=".$keywords."&page=".($page-1);
$gotoPageFirst = "huiyuanzhijia_list.php?cat_id=".$cat_id."&keywords=".$keywords."&page=".$totalpages;
?>
</table>
<!-- end goods list -->
...
function gotopages()
{
	window.location.href='huiyuanzhijia_list.php?cat_id=<?php echo $cat_id; ?>&keywords='+$("#keywords").val()+'&page='+$("#gotoPage").val();
}

...
if ($_REQUEST['action'] == 'delete')
{
	...
	$condition="id=".$id;
	$mysql->delete("liuyan",$condition);
	echo '<script>alert("操作成功");location.href="liuyan_list.php?keywords='.$keywords.'&page='.$page.'";</script>';
	exit;
}
...
<!-- 文章列表 -->
<form method="post" action="liuyan_list.php?keywords=<?php echo $keywords; ?>&page=<?php echo $page; ?>" name="listForm" onsubmit="return confirmSubmit(this)">
  <!-- start goods list -->
...
<table width="1103" cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th width="54">ID</th>
    <th width="249">留言标题</th>
    <th width="132">姓名</th>
    <th width="135">电子邮箱</th>
...
<?php 
$maxnum = 50;  //每页显示记录条数
$sql = "SELECT * FROM liuyan where 1=1";
if($keywords!='')
{
...
?>
  <tr>
    ...
    <td class="first-cell" style=""><a href="liuyan_view.php?id=<?php echo $result['id']; ?>"><?php echo $result['title']; ?></a></td>
    ...
    <td align="center">
     <a href="liuyan_list.php?action=delete&id=<?php echo $result['id']; ?>" title="" onClick="return confirm('您确定进行删除操作吗？')"><img src="images/icon_trash.gif" width="16" height="16" border="0" /></a>
    </td>
  </tr>
<?php
}
$gotoPageFirst = "liuyan_list.php?keywords=".$keywords."&page=1";
$gotoPagePrev = "liuyan_list.php?keywords=".$keywords."&page=".($page-1);
$gotoPageNext = "liuyan_list.php?keywords=".$keywords."&page=".($page-1);
$gotoPageFirst = "liuyan_list.php?keywords=".$keywords."&page=".$totalpages;
?>
</table>
<!-- end goods list -->
...
function gotopages()
{
	window.location.href='liuyan_list.php?keywords='+$("#keywords").val()+'&page='+$("#gotoPage").val();
}

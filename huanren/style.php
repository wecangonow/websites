...
<!--背景-->
<div class="qing bg"><span class="qing"><img src="images/bg_style.jpg" width="100%" /></span></div>
<!--标题-->
<div class="qing mtop">
	<div class="qing title">
    	<div class="qing center">
            ...
            <div class="rf ti_jie">
            	<span>当前位置： </span><a href="index.php">首页</a><span class="song"> > </span><span>企业风采</span>
            </div>
        </div>
    </div>
</div>
<!-- 内容区 -->
<div class="qing center fc">
	<ul class="qing">
        <?php
        $this_page_url="style.php";
        $maxnum = 12;  //每页显示记录条数
        $sql = "SELECT * FROM news where 1=1 and cat_id=13";
        ...
        <li class="lf">
        	<div class="qing qi_jie">
            	<a href="style_view.php?id=<?php echo $row_list['id'];?>" class="lf qi_img"><img src="<?php echo $row_list['picture'];?>" width="138" height="158" /></a>
             	<div class="rf qi_shao">
                  	<a href="style_view.php?id=<?php echo $row_list['id'];?>" class="qing qi_bt">
                        <?php echo $row_list['title'];?>
                    </a>
                   	<a href="style_view.php?id=<?php echo $row_list['id'];?>" class="qing qi_jian">
                        <?php echo $row_list['content'];?>
                    </a>
                  	<a href="style_view.php?id=<?php echo $row_list['id'];?>" class="qing qi_more">[详情]</a>
            	</div>
          	</div>

...
if($_REQUEST["action"]=="edit")
{
    ...
    $condition="id=".$id;
    $dataArray = array("title"=>$title,"company_title"=>$company_title,"picture"=>$picture,"text_picture"=>$text_picture,"laiyuan"=>$laiyuan,"tags"=>$tags,"sort_order"=>$sort_order,"note"=>$note,"content"=>$content,"add_time"=>$add_time);
...
?>
    <!-- tab body -->
    <div id="tabbody-div">
      <form action="huiyuanzhijia_edit.php?action=edit&id=<?php echo $id; ?>&L_cat_id=<?php echo $L_cat_id; ?>&L_keywords=<?php echo $L_keywords; ?>&L_page=<?php echo $L_page; ?>" method="post" name="theForm" onsubmit="return check_submit();">
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            ...
            <td><input type="text" name="picture" id="picture" class="input_text" value="<?php echo $result['picture']; ?>" />&nbsp;<input name="upfile" type="button" class="button" onClick="javascript:opw('includes/pic_upload_form.php?text_id=picture&saveTo=../../upload/images/&showPath=upload/images/','picture',500,250)" value="上传图片"> (544*363)</td>
          </tr>
          <tr>
            <td class="label">文字图片</td>
            <td><input type="text" name="text_picture" id="text_picture" class="input_text" value="<?php echo $result['text_picture']; ?>" />&nbsp;<input name="upfile" type="button" class="button" onClick="javascript:opw('includes/pic_upload_form.php?text_id=text_picture&saveTo=../../upload/images/&showPath=upload/images/','text_picture',500,250)" value="上传图片"> (140*186)</td>
          </tr>
          <tr>

...
if($_REQUEST["action"]=="add")
{
    ...
    $dataArray = array("title"=>$title,"company_title"=>$company_title,
        "cat_id"=>$cat_id,
        "picture"=>$picture,
        "laiyuan"=>$laiyuan,
        "tags"=>$tags,
...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
      <form action="meeting_add.php?action=add&cat_id=<?php echo $cat_id; ?>" method="post" name="theForm" onsubmit="return check_submit();">

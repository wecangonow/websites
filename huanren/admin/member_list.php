...
<!-- 文章列表 -->
<form method="post" action="contact_list.php?L_cat_id=<?php echo $cat_id; ?>&L_keywords=<?php echo $keywords; ?>&L_page=<?php echo $page; ?>" name="listForm" onsubmit="return confirmSubmit(this)">
  <!-- start goods list -->
  <div class="list-div" id="listDiv">
<table width="1103" cellpadding="3" cellspacing="1">
  <tr>
    <th width="44"><input name="checkall" id="checkall" type="checkbox" /></th>
    <th width="63">ID</th>
    <th width="98">姓名</th>
    <th width="252">公司名称</th>
    <th width="97">电话</th>
...
<?php 
$maxnum = 50;  //每页显示记录条数
$sql = "SELECT * FROM member_list where 1=1";
if($keywords!='')
{
	$sql = $sql." and (name like '%$keywords%' )";
}
...
?>
  <tr>
    ...
    <td align="center"><?php echo $result['id']; ?></td>
        <!--
    <td class="first-cell" style=""><a href="contact_edit.php?id=<?php echo $result['id']; ?>&L_cat_id=<?php echo $cat_id; ?>&L_keywords=<?php echo $keywords; ?>&L_page=<?php echo $page; ?>"><?php echo $result['title']; ?></a></td>
    -->
    <td align="center"><?php echo $result['name']; ?></td>
    <td align="center"><?php echo $result['company_name']; ?></td>
    <td align="center"><?php echo $result['phone']; ?></td>
        <td align="center"><?php echo $result['email']; ?></td>
        <td align="center"><?php echo $result['youbian']; ?></td>
...
$gotoPageFirst = "contact_list.php?cat_id=".$cat_id."&keywords=".$keywords."&page=1";
$gotoPagePrev = "contact_list.php?cat_id=".$cat_id."&keywords=".$keywords."&page=".($page-1);
$gotoPageNext = "contact_list.php?cat_id=".$cat_id."&keywords=".$keywords."&page=".($page-1);
$gotoPageFirst = "contact_list.php?cat_id=".$cat_id."&keywords=".$keywords."&page=".$totalpages;
?>
</table>
<!-- end goods list -->
...
function gotopages()
{
	window.location.href='contact_list.php?cat_id=<?php echo $cat_id; ?>&keywords='+$("#keywords").val()+'&page='+$("#gotoPage").val();
}

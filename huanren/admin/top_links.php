...
if($_REQUEST["action"]=="add")
{
	...
	echo '<script>alert("操作成功");location.href="top_links.php?cat_id='.$cat_id.'";</script>';
	exit;
}
...
{
?>
  <form method="post" action="top_links.php?action=edit&id=<?php echo $result['id']; ?>&cat_id=<?php echo $result['cat_id']; ?>" name="listForm_<?php echo $result['id']; ?>">
  <tr>

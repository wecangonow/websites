...
if($_REQUEST["action"]=="add")
{
    ...
    $dataArray = array("parent_id"=>$parent_id,"cat_id"=>$cat_id,
                       "title"=>$title,
                       "cat_id"=>$cat_id,
                       "picture"=>$picture,
                       "file_url"=>$file_url,
	...
	echo '<script>alert("操作成功");location.href="lianjie_list.php?parent_id='.$parent_id.'";</script>';
	exit;
}
...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
      <form action="lianjie_add.php?action=add&parent_id=<?php echo $parent_id; ?>" method="post" name="theForm" onsubmit="return check_submit();">
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            ...
            <tr>
                ...
                <td width="83%"><input type="text" name="link_url" id="link_url" class="input_text" value="" /></td>
            </tr>

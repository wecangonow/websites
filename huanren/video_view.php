...
$sql="select * from news where cat_id=12 and id>".$news_view["id"]." order by id asc limit 0,1";
...
{
    $prev_info=array('title'=>$prev_info['title'],'url'=>'video_view.php?id='.$prev_info['id']);
}

$sql="select * from news where cat_id=12 and id<".$news_view["id"]." order by id desc limit 0,1";
...
{
    $next_info=array('title'=>$next_info['title'],'url'=>'video_view.php?id='.$next_info['id']);
}
?>
	...
	<div class="qing title">
    	<div class="qing center">
        	<div class="lf hui_bt">
                ...
                <div class="qing hui_ying">Activities Video</div>

...
<div class="qing mtop">
	<div class="qing title">
    	<div class="qing center">
        	<div class="lf hui_bt">
            	<div class="qing hui_zi"><span>搜</span>索结果</div>
                <div class="qing hui_ying">Search Result</div>
            ...
            <div class="rf ti_jie">
            	<span>当前位置： </span><a href="index.php">首页</a><span class="song"> > </span><span>搜索结果</span>
            </div>
        </div>
    </div>
</div>
...
<div class="qing center">
	<!--展开开始-->
    <?php
    $this_page_url="search_nlist.php";
    $maxnum = 20;  //每页显示记录条数
        ...
        <table border="0" cellspacing="0" cellpadding="0" style="margin-left:auto; margin-right:auto;">
            <tr>
                <td align="center" valign="top">
                    <?php if($page != 1){?>
                        <a href="<?php echo $this_page_url.'?page='.($page-1).'&keywords='.$keywords;?>">
                    ...
                    {
                        ?>
                        <a href="<?php echo $this_page_url.'?page='.$p.'&keywords='.$keywords;?>"<?php if($p==$page) {?> class="yenn"<?php }?>><?php echo $p;?></a>
                    <?php
                    }
                    ?>

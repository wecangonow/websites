...
if($_REQUEST["action"]=="add")
{
	...
	echo '<script>alert("操作成功");location.href="guandian_add.php?cat_id='.$cat_id.'";</script>';
	exit;
}
...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
      <form action="guandian_add.php?action=add&cat_id=<?php echo $cat_id; ?>" method="post" name="theForm" onsubmit="return check_submit();">

...
if($_REQUEST["action"]=="edit")
{
    ...
    $condition="id=".$id;
    $dataArray = array("cat_id"=>$cat_id,"title"=>$title,"company_title"=>$company_title,"picture"=>$picture,"text_picture"=>$text_picture,"text2_picture"=>$text2_picture,"file_url"=>$file_url,"laiyuan"=>$laiyuan,"tags"=>$tags,"sort_order"=>$sort_order,"note"=>$note,"content"=>$content,"add_time"=>$add_time);
...
?>
    <!-- tab body -->
    <div id="tabbody-div">
      <form action="jidi_edit.php?action=edit&id=<?php echo $result['id']; ?>&L_parent_id=<?php echo $L_parent_id; ?>&L_cat_id=<?php echo $L_cat_id; ?>&L_keywords=<?php echo $L_keywords; ?>&L_page=<?php echo $L_page; ?>" method="post" name="theForm" onsubmit="return check_submit();">
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            ...
            <td><input type="text" name="picture" id="picture" class="input_text" value="<?php echo $result['picture']; ?>" />&nbsp;<input name="upfile" type="button" class="button" onClick="javascript:opw('includes/pic_upload_form.php?text_id=picture&saveTo=../../upload/images/&showPath=upload/images/','picture',500,250)" value="上传图片"> (295*214)</td>
          </tr>
          <tr>

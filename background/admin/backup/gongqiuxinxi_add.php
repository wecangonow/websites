...
if($_REQUEST["action"]=="add")
{
	...
	echo '<script>alert("操作成功");location.href="gongqiuxinxi_add.php?parent_id='.$parent_id.'";</script>';
	exit;
}
...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
      <form action="gongqiuxinxi_add.php?action=add&parent_id=<?php echo $parent_id; ?>" method="post" name="theForm" onsubmit="return check_submit();">

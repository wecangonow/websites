...
if($_REQUEST["action"]=="add")
{
	...
	echo '<script>alert("操作成功");location.href="flash.php?cat_id='.$cat_id.'";</script>';
	exit;
}
...
?>
  ...
  <tr>
    ...
    <td align="center">
      ...
      <a href="flash.php?action=delete&id=<?php echo $result['id']; ?>&cat_id=<?php echo $result['cat_id']; ?>" title="删除" onClick="return confirm('您确定进行删除操作吗？')"><img src="images/icon_trash.gif" width="16" height="16" border="0" /></a>
    </td>
  </tr>
  </form>
<?php 
...
<table width="1103" cellpadding="3" cellspacing="1" style="margin-top:20px;">
  <tr>
    ...
    <th width="89">操作</th>
  <tr>
  <form method="post" action="flash.php?action=add&cat_id=<?php echo $cat_id; ?>" name="listForm" onsubmit="return confirmSubmit(this)">
  <tr>
    <td align="center" class="center" style=""><input type='text' name='title' class="input_text_2" value='' /></td>
    <td align="center"><input type='text' name='picture' id="picture_0" class="input_text_2" value='' />&nbsp;<input name="upfile" type="button" class="button" onClick="javascript:opw('includes/pic_upload_form.php?text_id=picture_0&saveTo=../../upload/images/&showPath=upload/images/','sys_mobileweb_picture',500,250)" value="上传图片"> (<?php echo $pic_size; ?>)</td>

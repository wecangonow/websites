...
if($_REQUEST["action"]=="add")
{
	...
	echo '<script>alert("操作成功");location.href="job_add.php?cat_id='.$cat_id.'";</script>';
	exit;
}
...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
      <form action="job_add.php?action=add&cat_id=<?php echo $cat_id; ?>" method="post" name="theForm" onsubmit="return check_submit();">
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            ...
            <td>
              <script id="note" name="note" type="text/plain"></script>

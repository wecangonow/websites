...
if($_REQUEST["action"]=="add")
{
    ...
    $dataArray = array("title"=>$title,"cat_id"=>$cat_id,"picture"=>$picture,"laiyuan"=>$laiyuan,"tags"=>$tags,"sort_order"=>$sort_order,"note"=>$note,"content"=>$content,"add_time"=>$add_time);
	$mysql->insert("news",$dataArray);
	echo '<script>alert("操作成功");location.href="product_add.php?cat_id='.$cat_id.'";</script>';
	exit;
}
...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
      <form action="product_add.php?action=add&cat_id=<?php echo $cat_id; ?>" method="post" name="theForm" onsubmit="return check_submit();">
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            ...
            <td><input type="text" name="picture" id="picture" class="input_text" value="" />&nbsp;<input name="upfile" type="button" class="button" onClick="javascript:opw('includes/pic_upload_form.php?text_id=picture&saveTo=../../upload/images/&showPath=upload/images/','picture',500,250)" value="上传图片"> (174*174)</td>
          </tr>
          <tr>

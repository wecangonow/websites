...
if($_REQUEST["action"]=="edit")
{
	...
	$sell_price = !empty($_POST['sell_price']) ? $_POST['sell_price'] : '';
    ...
    $condition="id=".$id;
    $dataArray = array("title"=>$title,"sell_price"=>$sell_price,"picture"=>$picture,"laiyuan"=>$laiyuan,"tags"=>$tags,"sort_order"=>$sort_order,"note"=>$note,"content"=>$content,"add_time"=>$add_time);
...
?>
    <!-- tab body -->
    <div id="tabbody-div">
      <form action="tutechan_edit.php?action=edit&id=<?php echo $id; ?>&L_cat_id=<?php echo $L_cat_id; ?>&L_keywords=<?php echo $L_keywords; ?>&L_page=<?php echo $L_page; ?>" method="post" name="theForm" onsubmit="return check_submit();">
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            <td width="17%" class="label">单价</td>
            <td width="83%"><input type="text" name="sell_price" id="sell_price" class="input_text" value="<?php echo $result['sell_price']; ?>" /></td>
          </tr>
          <tr>
            <td class="label">上传图片</td>
            <td><input type="text" name="picture" id="picture" class="input_text" value="<?php echo $result['picture']; ?>" />&nbsp;<input name="upfile" type="button" class="button" onClick="javascript:opw('includes/pic_upload_form.php?text_id=picture&saveTo=../../upload/images/&showPath=upload/images/','picture',500,250)" value="上传图片"> (214*224)</td>
          </tr>
          <tr>
